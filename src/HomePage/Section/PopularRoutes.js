                    ...
                    <div className='routes-body'>
                        ...
                        <Slider {...settings}>
                            <div className='img-customize'>
                                ...
                                <div style={{ color: 'white' }}>Sài Gòn - Vũng Tàu</div>
                            </div>
                            <div className='img-customize'>
                                <img src={popularRoute2} alt='' />
                                <div style={{ color: 'white' }}>Hà Nội - Hải Phòng</div>
                            </div>
                            <div className='img-customize'>
                                <img src={popularRoute3} alt='' />
                                <div style={{ color: 'white' }}>Sài Gòn - Nha Trang</div>
                            </div>
                            <div className='img-customize'>
                                <img src={popularRoute4} alt='' />
                                <div style={{ color: 'white' }}>Sài Gòn - Đà Nẵng</div>
                            </div>
                            <div className='img-customize'>
                                <img src={popularRoute5} alt='' />
                                <div style={{ color: 'white' }}>Hà Nội - Vịnh Hạ Long</div>
                            </div>
                            <div className='img-customize'>
                                <img src={popularRoute6} alt='' />
                                <div style={{ color: 'white' }}>Sài Gòn - Phan Rang</div>
                            </div>
